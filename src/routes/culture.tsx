...
export const Route = createFileRoute("/culture")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Descubra curiosidades, frases úteis e vocabulário de 8 cidades: London, New York, Sydney, Toronto, Dublin, Madrid, Barcelona e Mexico City.",
      },
    ],
  }),
...
function CulturePage() {
  ...
  const languageNameByTarget: Record<string, string> = { en: "English", es: "Spanish", pt: "Portuguese" };
      ...
      <section style={{
        ...
        >
          <div style={{
            ...
            <span style={{ fontSize: "11px", fontWeight: 800, color: "var(--brand)", letterSpacing: "0.1em", textTransform: "uppercase" }}>
          ...
          <div style={{
            ...
            {[
              ...
              <div key={i} style={{
                ...
                <span style={{ fontSize: "14px", fontWeight: 800, color: "var(--text-primary)" }}>{stat.value}</span>
          ...
          {cities.map((city, i) => (
            ...
            >
              ...
              <div style={{
                ...
                <div style={{ display: "flex", gap: "12px", fontSize: "12px", color: "var(--text-secondary)", fontWeight: 600 }}>
                  <span>{city.curiosities.length} {t.curiosities}</span>
                  <span>•</span>
                  <span>{city.usefulPhrases.length} {t.phrases}</span>
                </div>
                <div style={{
                  width: "32px",
                  height: "32px",
