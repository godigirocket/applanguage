...
const SHOP_ITEMS = [
  { id: 'freeze', title: 'Congelamento de Ofensiva', desc: 'Mantenha sua ofensiva mesmo se perder um dia.', price: 50, icon: '<svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#2D4A3E" stroke-width="2" stroke-linecap="round"><path d="m10 20-2-2 2-2"/><path d="m14 20 2-2-2-2"/><path d="m14 4 2 2-2 2"/><path d="m10 4-2 2 2 2"/><path d="m2 14 2-2-2-2"/><path d="m22 14-2-2 2-2"/><path d="M12 2v20"/><path d="m3 9 18 6"/><path d="m3 15 18-6"/></svg>' },
  ...
  { id: 'bonus-xp', title: 'Poção de XP Duplo', desc: 'Ganha o dobro de XP pelos próximos 30 minutos.', price: 150, icon: '<svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#C4714A" stroke-width="2" stroke-linecap="round"><path d="M10 2v7.31"/><path d="M14 9.3V1.99"/><path d="M8.5 2h7"/><path d="M14 9.3a6.5 6.5 0 1 1-4 0"/><line x1="5.52" x2="18.48" y1="16" y2="16"/></svg>' },
];
    ...
    <div style={{ minHeight: '100vh', background: '#F7F4EF' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '60px 24px 120px', animation: 'pageEnter 0.6s ease-out both' }}>
        <div style={{ marginBottom: '48px', textAlign: 'center' }}>
          ...
          <div style={{ marginTop: '24px', display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'white', padding: '12px 24px', borderRadius: '99px', boxShadow: '0 4px 12px rgba(0,0,0,0.05)' }}>
            ...
            <div key={item.id} className="lume-card" style={{ background: 'white', borderRadius: '24px', padding: '24px', border: '1px solid #E0DDD650', display: 'flex', flexDirection: 'column' }}>
              ...
              <button 
                ...
                style={{
                  ...
                  background: lumes >= item.price ? '#C9A84C' : '#E0DDD6',
