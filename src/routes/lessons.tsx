        ...
        <div style={{ maxWidth: '680px', margin: '0 auto', padding: '32px 24px 120px' }}>
          ...
          <div className="glass" style={{ background: 'var(--surface-raised)', borderRadius: '24px', padding: '32px', border: '1px solid white', boxShadow: '0 8px 32px rgba(0,0,0,0.02)', animation: 'pageEnter 0.3s ease both' }}>
            ...
            {currentStep.type === 'intro' && (
              <div>
                <h2 style={{ fontFamily: 'Nunito, sans-serif', fontSize: '28px', marginBottom: '16px', color: 'var(--text-primary)', fontWeight: 800 }}>{currentStep.title}</h2>
            ...
            {currentStep.type === 'vocabulary' && (
              <div>
                <h2 style={{ fontFamily: 'Nunito, sans-serif', fontSize: '24px', marginBottom: '20px', color: 'var(--text-primary)', fontWeight: 800 }}>Vocabulário</h2>
            ...
            {(currentStep.type === 'quiz' || currentStep.type === 'listening') && (
              <div>
                ...
                <h2 style={{ fontFamily: 'Nunito, sans-serif', fontSize: '24px', marginBottom: '24px', color: 'var(--text-primary)', fontWeight: 750 }}>
            ...
            {currentStep.type === 'speaking' && currentStep.targetPhrase && (
              <div style={{ textAlign: 'center' }}>
                ...
                <h2 style={{ fontFamily: 'Nunito, sans-serif', fontSize: '28px', marginBottom: '16px', color: 'var(--text-primary)', fontWeight: 800 }}>
                  Leia em voz alta:
                </h2>
            ...
            {currentStep.type === 'practice' && (
              <div style={{ textAlign: 'center' }}>
                ...
                <h2 style={{ fontFamily: 'Nunito, sans-serif', fontSize: '24px', marginBottom: '8px', color: 'var(--text-primary)', fontWeight: 800 }}>Hora de praticar</h2>
    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '60px 24px 120px', animation: 'pageEnter 0.6s ease-out both' }}>
        <div style={{ marginBottom: '36px', textAlign: 'center' }}>
          <h1 style={{ fontFamily: 'Nunito, sans-serif', fontSize: 'clamp(28px,4vw,40px)', marginBottom: '6px', fontWeight: 800, color: 'var(--text-primary)' }}>
          ...
          {lessons.map(lesson => (
            <button key={lesson.id}
              ...
              <div className="lume-card" style={{
                ...
                <h3 style={{ fontFamily: 'Nunito, sans-serif', fontSize: '19px', fontWeight: 700, marginBottom: '8px', color: 'var(--text-primary)' }}>{lesson.title}</h3>
