  ...
  head: () => ({
    meta: [
      { title: "Lições de Idiomas — 630+ Lições Interativas | LumeLearn" },
      {
        name: "description",
        content:
          "Explore 630+ lições de inglês, espanhol e português. Vocabulário, gramática, listening, speaking e reading. Do A1 ao C2.",
      },
    ],
  }),
...
function LessonsPage() {
  ...
  useEffect(() => {
    let cancelled = false;
    generateLessons(targetLanguage, 210, completedLessons).then((lessons) => {
