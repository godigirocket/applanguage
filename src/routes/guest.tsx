        ...
        <div style={{ maxWidth: "680px", margin: "0 auto", textAlign: "center" }}>
            ...
            {[
              {
                ...
                desc: "Fale com a IA sobre qualquer tema",
                icon: (
                  <svg
                    width="28"
                    height="28"
              ...
              },
              {
                id: "quiz",
                title: "Quiz rápido",
                desc: "5 perguntas de vocabulário",
                icon: (
                  <svg
                    width="28"
                    height="28"
              ...
              },
              {
                id: "lesson",
                title: "Lição express",
                desc: "Aprenda 5 expressões novas",
                icon: (
                  <svg
                    width="28"
                    height="28"
          ...
          <button
            onClick={() => {
              if (selectedActivity) {
                setStarted(true);
                if (!localStorage.getItem("lume_guest_start")) {
                  localStorage.setItem("lume_guest_start", Date.now().toString());
                }
              }
            }}
      ...
      <div style={{ maxWidth: "860px", margin: "0 auto" }}>
        ...
        >
          <svg
            ...
            viewBox="0 0 24 24"
            fill="none"
            stroke={timeLeft < 120 ? "var(--accent-terra)" : "var(--accent-green)"}
            strokeWidth="2.5"
            strokeLinecap="round"
          >
            <circle cx="12" cy="12" r="10" />
          ...
          <div
            style={{
              ...
              fontSize: "18px",
              fontWeight: 700,
              color: timeLeft < 120 ? "var(--accent-terra)" : "var(--text-primary)",
              minWidth: "48px",
              textAlign: "right",
            }}
          >
        ...
        {showSignupModal && (
          ...
          >
            ...
            >
              ...
              >
                Seu tempo de demonstração terminou. Crie uma conta grátis para continuar praticando
...
const QUIZ_QUESTIONS = [
  {
    q: "O que significa 'circle back' no contexto profissional?",
    options: [
      "Voltar a falar sobre um assunto depois",
      "Mudar de sala",
      "Desenhar um círculo na lousa",
      "Cancelar o projeto",
    ],
    correct: 0,
  },
  {
    q: "Qual a melhor resposta curta para 'How was your weekend?'",
    options: ["I went well", "Pretty good, thanks!", "Yes, had weekend.", "Not have weekend."],
    correct: 1,
  },
  {
    q: "Como você diz 'entrar em contato' de forma casual?",
    options: ["Connect eye", "Touch base", "Make letters", "Send base"],
    correct: 1,
  },
  { q: "Qual o passado de 'go'?", options: ["went", "goed", "gone", "going"], correct: 0 },
  {
    q: "O que expressa a frase 'hanging in there'?",
    options: [
      "Desistir de tudo",
      "Estar muito feliz",
      "Seguir em frente apesar das dificuldades",
      "Segurar algo pesado",
    ],
    correct: 2,
  },
...
function GuestQuiz() {
  ...
  if (finished) {
    return (
      ...
      >
        ...
        >
          Cadastre-se para ganhar XP +{score * 10}!
        </a>
      </div>
    );
  }
  ...
  return (
    <div
      className="glass"
      style={{ padding: "32px", borderRadius: "24px", background: "var(--surface-raised)" }}
    >
      <div
        style={{
          display: "flex",
      ...
      >
        <span>
          Pergunta {qIndex + 1} de {QUIZ_QUESTIONS.length}
        </span>
...
function GuestConversation() {
  const [messages, setMessages] = useState<any[]>([
    {
      sender: "ai",
      text: "Olá! Sou o Lume. Como foi o seu dia? Escreva abaixo em inglês ou português para praticar!",
    },
  ]);
    ...
    >
        ...
        {messages.map((msg, i) => (
          <div
            ...
            style={{
              maxWidth: "85%",
              padding: "12px 16px",
              borderRadius: msg.sender === "ai" ? "4px 16px 16px 16px" : "16px 16px 4px 16px",
              alignSelf: msg.sender === "ai" ? "flex-start" : "flex-end",
              background:
                msg.sender === "ai" ? "var(--bg)" : "linear-gradient(135deg,#2D4A3E,#1B3A4B)",
              color: msg.sender === "ai" ? "var(--text-primary)" : "var(--surface-raised)",
              fontSize: "14px",
              lineHeight: 1.5,
            }}
          >
      ...
      <div style={{ display: "flex", gap: "10px" }}>
        <input
          ...
          placeholder="Fale ou escreva no chat..."
          style={{
            flex: 1,
            padding: "12px 20px",
            borderRadius: "99px",
...
const EXPRESSIONS = [
  {
    phrase: "Touch base",
    meaning: "Fazer um contato rápido, alinhar com alguém.",
    example: "Let's touch base tomorrow morning.",
  },
  {
    phrase: "Circle back",
    meaning: "Retornar a um assunto mais tarde.",
    example: "Circle back to this question after the meeting.",
  },
  {
    phrase: "Hanging in there",
    meaning: "Aguentar firme, lidando com uma situação difícil.",
    example: "It's a busy week, but I'm hanging in there.",
  },
  {
    phrase: "Serendipity",
    meaning: "A sorte de encontrar algo precioso de forma inesperada.",
    example: "Meeting him was pure serendipity.",
  },
  {
    phrase: "Off the cuff",
    meaning: "Fazer ou falar de improviso, sem preparação.",
    example: "I gave the presentation off the cuff.",
  },
];
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", gap: "10px", justifyContent: "center" }}>
        ...
        <button
          onClick={() => (idx + 1 < EXPRESSIONS.length ? setIdx((i) => i + 1) : setIdx(0))}
          style={{
            padding: "10px 24px",
            borderRadius: "99px",
            border: "none",
...
function GuestPronunciation() {
  ...
  const startListening = () => {
    ...
    recognition.onresult = (event: any) => {
      ...
      const targetWords = activePhrase
        .toLowerCase()
        .replace(/[^\w\s]/g, "")
        .split(/\s+/);
      const spokenWords = resultText
        .toLowerCase()
        .replace(/[^\w\s]/g, "")
        .split(/\s+/);
      ...
      <div style={{ marginBottom: "28px" }}>
        <button
          ...
          style={{
            ...
            height: "76px",
            borderRadius: "50%",
            background: listening ? "var(--accent-terra)" : "var(--accent-green)",
            border: "none",
            color: "var(--surface-raised)",
            display: "flex",
            alignItems: "center",
      ...
      {score !== null && (
        <div
          style={{
            ...
            padding: "16px 24px",
            borderRadius: "16px",
            background: score >= 80 ? "rgba(64,168,120,0.06)" : "rgba(224,123,84,0.06)",
            border: `1px solid ${score >= 80 ? "#40A878" : "#E07B54"}`,
          }}
        >
          <span
            style={{
              fontSize: "16px",
              color: score >= 80 ? "var(--accent-green)" : "var(--accent-terra)",
              fontWeight: 800,
            }}
          >
            Nota: {score}/100
