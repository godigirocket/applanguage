      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{marginBottom:'24px'}}>
            ...
            <h2 style={{fontFamily:'"Playfair Display", serif',fontSize:'20px',marginBottom:'4px'}}>{topicTitle}</h2>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{fontSize:'28px',fontFamily:'"Playfair Display", serif',fontWeight:700,color:'#2D4A3E'}}>
          ...
          <div style={{
            ...
            <div style={{fontSize:'22px',fontFamily:'"Playfair Display", serif',fontWeight:700,color:'#C9A84C'}}>
              +{sessionXP} XP
            </div>
              ...
              <div style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:'12px',marginBottom:'24px'}}>
                {[
                  ...
                  <div key={i} style={{padding:'14px 8px',background:'#F7F4EF',borderRadius:'14px'}}>
                    ...
                    <div style={{fontFamily:'"Playfair Display", serif',fontSize:'20px',fontWeight:700,color:'#1C1C1A'}}>{stat.value}</div>
